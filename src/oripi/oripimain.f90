...
program oripimain
  ...
  use oripireheat, only : oripi_lnrhoreh_max, oripi_x_star
  use infinout, only : delete_file, livewrite
  use srreheat, only : log_energy_reheat_ingev

  use oripisr, only : oripi_norm_potential, oripi_x_endinf
  ...
  do j=1,nphi0
     ...
     do i=1,npts
        ...
        eps3 = oripi_epsilon_three(xstar,phi0)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  call delete_file('oripi_predic_summarized.dat') 
  nphi0=1000
  phi0min=10.**(-3.)
  phi0max=10.**(-3.)
  w=0._kp
  do j=1,nphi0
     ...
     rB =16._kp*eps1B
     call livewrite('oripi_predic_summarized.dat',eps1A,eps2A,eps3A,rA,nsA,eps1B,eps2B,eps3B,rB,nsB)
  enddo

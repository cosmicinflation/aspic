...
!take as input the parametric field hbar  
  public nmlfi2_lnrhoreh_max
  public nmlfi2_hbar_star, nmlfi2_hbar_rrad, nmlfi2_hbar_rreh

!for convenience only
  public nmlfi2_x_star, nmlfi2_x_rrad, nmlfi2_x_rreh
...
!jordan frame
  function nmlfi2_lnrhoreh_max(xi,p,hbarend,Pstar)
    implicit none
    real(kp) :: nmlfi2_lnrhoreh_max
    real(kp), intent(in) :: xi,p,hbarend,Pstar

    nmlfi2_lnrhoreh_max = nmlfi_lnrhoreh_max(xi,p,hbarend,Pstar)
